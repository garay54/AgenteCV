# Registro de riesgos — Agente de CV

## 1. Propósito

Este documento identifica los riesgos que pueden impedir que el agente funcione, se integre con la plataforma cliente o sea demostrado antes del miércoles 19 de agosto de 2026 a las 12:00, hora de Chihuahua.
...
| RK-08 | Incompatibilidad con el contrato Open Responses de la plataforma cliente | Crítica | La plataforma rechaza el endpoint, no interpreta la respuesta o corta el streaming | Implementar el contrato documentado y aislar la transformación de entrada y salida del núcleo del agente | Observar solicitudes reales, corregir sólo el adaptador del contrato y repetir la prueba en la plataforma cliente | Solicitud y respuesta aceptadas, logs seguros y captura de una conversación funcional | Mitigado: integración y SSE aceptados |
